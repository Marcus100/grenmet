 ...
 */
export function hrListAssignments<ThrowOnError extends boolean = true>(
  options: Options<HrListAssignmentsOptions, ThrowOnError>
): Unwrappable<RequestResult<HrListAssignmentsResponses, ThrowOnError>> {
  ...
  return withUnwrap(
    request({
      ...
      ...config,
    }) as Promise<RequestResult<HrListAssignmentsResponses, ThrowOnError>>
  );
}
