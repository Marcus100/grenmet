...
*/
export type ValidateCsvApiV1HrRostersImportCsvValidatePost200 = RosterCsvValidationResponse;
...
*/
export type ValidateCsvApiV1HrRostersImportCsvValidatePost422 = HTTPValidationError;

/**
 * RosterCsvValidationRequest
*/
export type ValidateCsvApiV1HrRostersImportCsvValidatePostMutationRequest = RosterCsvValidationRequest;

export type ValidateCsvApiV1HrRostersImportCsvValidatePostMutationResponse = ValidateCsvApiV1HrRostersImportCsvValidatePost200;
...
export type ValidateCsvApiV1HrRostersImportCsvValidatePostMutation = {
    ...
    Errors: ValidateCsvApiV1HrRostersImportCsvValidatePost400 | ValidateCsvApiV1HrRostersImportCsvValidatePost403 | ValidateCsvApiV1HrRostersImportCsvValidatePost422;
};