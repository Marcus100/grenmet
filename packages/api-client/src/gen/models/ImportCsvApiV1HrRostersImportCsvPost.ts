...
*/
export type ImportCsvApiV1HrRostersImportCsvPostMutationRequest = RosterCsvValidationRequest;

export type ImportCsvApiV1HrRostersImportCsvPostMutationResponse = ImportCsvApiV1HrRostersImportCsvPost200;
...
export type ImportCsvApiV1HrRostersImportCsvPostMutation = {
    ...
    Errors: ImportCsvApiV1HrRostersImportCsvPost400 | ImportCsvApiV1HrRostersImportCsvPost403 | ImportCsvApiV1HrRostersImportCsvPost422;
};