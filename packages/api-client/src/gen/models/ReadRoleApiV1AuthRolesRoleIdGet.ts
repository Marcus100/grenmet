...
export type ReadRoleApiV1AuthRolesRoleIdGetQueryResponse = ReadRoleApiV1AuthRolesRoleIdGet200;
...
export type ReadRoleApiV1AuthRolesRoleIdGetQuery = {
    ...
    Errors: ReadRoleApiV1AuthRolesRoleIdGet404 | ReadRoleApiV1AuthRolesRoleIdGet422;
};