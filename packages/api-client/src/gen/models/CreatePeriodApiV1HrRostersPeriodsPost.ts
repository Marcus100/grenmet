 ...
 * RosterPeriodCreate
*/
export type CreatePeriodApiV1HrRostersPeriodsPostMutationRequest = RosterPeriodCreate;

export type CreatePeriodApiV1HrRostersPeriodsPostMutationResponse = (CreatePeriodApiV1HrRostersPeriodsPost200 | CreatePeriodApiV1HrRostersPeriodsPost201);

export type CreatePeriodApiV1HrRostersPeriodsPostMutation = {
    Response: CreatePeriodApiV1HrRostersPeriodsPost200 | CreatePeriodApiV1HrRostersPeriodsPost201;
    Request: CreatePeriodApiV1HrRostersPeriodsPostMutationRequest;
    Errors: CreatePeriodApiV1HrRostersPeriodsPost400 | CreatePeriodApiV1HrRostersPeriodsPost403 | CreatePeriodApiV1HrRostersPeriodsPost422;
};