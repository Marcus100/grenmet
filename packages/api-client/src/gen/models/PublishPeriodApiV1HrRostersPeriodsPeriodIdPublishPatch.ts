...
*/
export type PublishPeriodApiV1HrRostersPeriodsPeriodIdPublishPatch200 = RosterPeriodPublic;
...
*/
export type PublishPeriodApiV1HrRostersPeriodsPeriodIdPublishPatch422 = HTTPValidationError;

export type PublishPeriodApiV1HrRostersPeriodsPeriodIdPublishPatchMutationResponse = PublishPeriodApiV1HrRostersPeriodsPeriodIdPublishPatch200;
...
export type PublishPeriodApiV1HrRostersPeriodsPeriodIdPublishPatchMutation = {
    ...
    Errors: PublishPeriodApiV1HrRostersPeriodsPeriodIdPublishPatch400 | PublishPeriodApiV1HrRostersPeriodsPeriodIdPublishPatch403 | PublishPeriodApiV1HrRostersPeriodsPeriodIdPublishPatch404 | PublishPeriodApiV1HrRostersPeriodsPeriodIdPublishPatch422;
};