 ...
 */
export const createStatusReportEndpointApiV1HrStatusReportsPost403Schema =
  z.any();

/**
 * @description Validation Error
 */
export const createStatusReportEndpointApiV1HrStatusReportsPost422Schema =
  z.lazy(() => HTTPValidationErrorSchema);

export const createStatusReportEndpointApiV1HrStatusReportsPostMutationRequestSchema =
