...
export const readRoleAssignmentsApiV1AuthRoleAssignmentsGetSuspenseQueryKey = (
...
export type ReadRoleAssignmentsApiV1AuthRoleAssignmentsGetSuspenseQueryKey =
  ReturnType<
    typeof readRoleAssignmentsApiV1AuthRoleAssignmentsGetSuspenseQueryKey
  >;

export function readRoleAssignmentsApiV1AuthRoleAssignmentsGetSuspenseQueryOptions(
  params?: ReadRoleAssignmentsApiV1AuthRoleAssignmentsGetQueryParams,
  config: Partial<RequestConfig> & { client?: Client } = {}
) {
  const queryKey =
    readRoleAssignmentsApiV1AuthRoleAssignmentsGetSuspenseQueryKey(params);
  return queryOptions<
    ReadRoleAssignmentsApiV1AuthRoleAssignmentsGetQueryResponse,
 ...
 */
export function useReadRoleAssignmentsApiV1AuthRoleAssignmentsGetSuspense<
  TData = ReadRoleAssignmentsApiV1AuthRoleAssignmentsGetQueryResponse,
  TQueryKey extends
    QueryKey = ReadRoleAssignmentsApiV1AuthRoleAssignmentsGetSuspenseQueryKey,
>(
  params?: ReadRoleAssignmentsApiV1AuthRoleAssignmentsGetQueryParams,
  options: {
    query?: Partial<
