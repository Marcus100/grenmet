...
export type ReadInstanceApiV1HrWorkflowsInstancesInstanceIdGetSuspenseQueryKey =
  ReturnType<
    typeof readInstanceApiV1HrWorkflowsInstancesInstanceIdGetSuspenseQueryKey
  >;

export function readInstanceApiV1HrWorkflowsInstancesInstanceIdGetSuspenseQueryOptions(
  instance_id: ReadInstanceApiV1HrWorkflowsInstancesInstanceIdGetPathParams["instance_id"],
...
export function useReadInstanceApiV1HrWorkflowsInstancesInstanceIdGetSuspense<
  ...
  TQueryKey extends
    QueryKey = ReadInstanceApiV1HrWorkflowsInstancesInstanceIdGetSuspenseQueryKey,
>(
  instance_id: ReadInstanceApiV1HrWorkflowsInstancesInstanceIdGetPathParams["instance_id"],
  options: {
    query?: Partial<
