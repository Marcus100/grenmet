...
export type ReadStatusReportEndpointApiV1HrStatusReportsReportIdGetSuspenseQueryKey =
  ReturnType<
    typeof readStatusReportEndpointApiV1HrStatusReportsReportIdGetSuspenseQueryKey
  >;

export function readStatusReportEndpointApiV1HrStatusReportsReportIdGetSuspenseQueryOptions(
  report_id: ReadStatusReportEndpointApiV1HrStatusReportsReportIdGetPathParams["report_id"],
...
export function useReadStatusReportEndpointApiV1HrStatusReportsReportIdGetSuspense<
  ...
  TQueryKey extends
    QueryKey = ReadStatusReportEndpointApiV1HrStatusReportsReportIdGetSuspenseQueryKey,
>(
  report_id: ReadStatusReportEndpointApiV1HrStatusReportsReportIdGetPathParams["report_id"],
  options: {
    query?: Partial<
