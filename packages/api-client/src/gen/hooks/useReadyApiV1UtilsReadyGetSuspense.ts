...
export type ReadyApiV1UtilsReadyGetSuspenseQueryKey = ReturnType<
  typeof readyApiV1UtilsReadyGetSuspenseQueryKey
>;

export function readyApiV1UtilsReadyGetSuspenseQueryOptions(
 ...
 */
export function useReadyApiV1UtilsReadyGetSuspense<
  TData = ReadyApiV1UtilsReadyGetQueryResponse,
  TQueryKey extends QueryKey = ReadyApiV1UtilsReadyGetSuspenseQueryKey,
>(
  options: {
    query?: Partial<
      UseSuspenseQueryOptions<
  ...
  const queryKey =
    queryOptions?.queryKey ?? readyApiV1UtilsReadyGetSuspenseQueryKey();
