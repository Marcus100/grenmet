...
export const readHrProfileMeApiV1HrProfileMeGetSuspenseQueryKey = () =>
  [{ url: "/api/v1/hr/profile/me" }] as const;

export type ReadHrProfileMeApiV1HrProfileMeGetSuspenseQueryKey = ReturnType<
  typeof readHrProfileMeApiV1HrProfileMeGetSuspenseQueryKey
>;

export function readHrProfileMeApiV1HrProfileMeGetSuspenseQueryOptions(
...
export function useReadHrProfileMeApiV1HrProfileMeGetSuspense<
  ...
  TQueryKey extends
    QueryKey = ReadHrProfileMeApiV1HrProfileMeGetSuspenseQueryKey,
>(
  options: {
    query?: Partial<
      UseSuspenseQueryOptions<
