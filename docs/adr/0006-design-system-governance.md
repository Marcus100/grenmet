...
Use `@barrelsgd/ui` as the shared UI package and `docs/design-system.md` as the implementation guide for tokens, component lanes, Figma alignment, and drift checks.

## Consequences

- Apps should import shared primitives from `@barrelsgd/ui/components/ui/<name>`.
