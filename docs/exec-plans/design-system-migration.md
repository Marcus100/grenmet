...
`@barrelsgd/ui` and apply it consistently across `admin-gms` first, then
...
- `apps/web/admin-gms` — first app to fully adopt `@barrelsgd/ui`
...
- [ ] All admin-gms pages using `@barrelsgd/ui` exclusively
