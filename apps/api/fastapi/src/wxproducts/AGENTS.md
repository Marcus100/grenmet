...
## Layout
`service.py` (published/authored products, history, write, aviation drafts, PDF source), `forecast.py`, `observations.py`/`observation_service.py`, `validation.py`, `pdf.py` + `fonts/`, `fields.json`, `router.py` (`/api/v1/wxproducts/*`).
