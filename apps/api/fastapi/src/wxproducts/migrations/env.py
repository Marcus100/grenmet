...
from src.wxproducts.config import wxproducts_settings
...
def migrate(connection: Connection) -> None:
    ...
    context.configure(
        ...
        version_table="wxproducts_alembic_version",
...
if existing is not None:
    ...
    if not wxproducts_settings.DATABASE_URL:
        raise RuntimeError("WXPRODUCTS_DATABASE_URL is required")
    url = make_url(wxproducts_settings.DATABASE_URL)
