...
```bash
# Using curl
curl -X POST "http://localhost:8000/api/v1/utils/test-email?email_to=test@barrels.gd"

# Using httpie
http POST http://localhost:8000/api/v1/utils/test-email email_to=test@barrels.gd
```
...
### Image
```mjml
<mj-image width="200px" src="https://barrels.gd/logo.png"></mj-image>
```
