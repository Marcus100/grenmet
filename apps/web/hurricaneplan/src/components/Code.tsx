...
function CodeGroupHeader({
  ...
  return (
    <div className="flex min-h-[calc(--spacing(12)+1px)] flex-wrap items-start gap-x-4 border-zinc-700 border-b bg-zinc-800 px-4 dark:border-zinc-800 dark:bg-transparent">
      {title && (
