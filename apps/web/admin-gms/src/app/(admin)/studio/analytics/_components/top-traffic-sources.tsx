  ...
  return (
    <Card className="h-full gap-2">
      ...
      <CardContent className="px-0">
        <Tabs className="flex flex-col gap-3" defaultValue="sources">
          <TabsList
          ...
          <TabsContent className="px-4" value="sources">
            <TrafficSourceBarChart data={sourcesData} />
          </TabsContent>

          <TabsContent className="px-4" value="campaigns">
            <TrafficSourceBarChart data={campaignsData} />
          </TabsContent>
          <TabsContent className="px-4" value="referrers">
