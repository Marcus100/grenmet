...
function TrafficSourceIconLabel({
  ...
  return (
    <foreignObject height={iconSize} width={iconSize} x={iconX} y={iconY}>
      <SimpleIcon className="size-4 fill-foreground" icon={source.icon} />
    </foreignObject>
  );
}
...
export function TrafficSources() {
  return (
    <Card>
      ...
      <CardContent>
        <ChartContainer className="h-54 w-full" config={trafficSourcesConfig}>
          <BarChart
            accessibilityLayer
            barCategoryGap={12}
            data={trafficSources}
