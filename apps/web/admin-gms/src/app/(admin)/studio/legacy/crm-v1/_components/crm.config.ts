import type { ChartConfig } from "@grenmet/ui/components/ui/chart";
...
export const projectRevenueChartData = [
  { name: "MVP Development", actual: 82_000, target: 90_000 },
  { name: "Consultation", actual: 48_000, target: 65_000 },
  { name: "Framer Sites", actual: 34_000, target: 45_000 },
  { name: "DevOps Support", actual: 77_000, target: 90_000 },
  { name: "LLM Training", actual: 68_000, target: 80_000 },
  { name: "Product Launch", actual: 52_000, target: 70_000 },
].map((row) => ({
  ...row,
