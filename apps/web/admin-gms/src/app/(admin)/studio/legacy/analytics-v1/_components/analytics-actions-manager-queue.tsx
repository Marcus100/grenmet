        ...
        <div className="flex h-full flex-col gap-3">
          <div className="grid grid-cols-2 gap-2">
            ...
            <StatCard
              ...
              mono
              value={formatCurrency(811_000, { noDecimals: true })}
            />
            <StatCard label="Owners engaged" value="3" />
            <StatCard label="Median risk" mono value="72" />
          </div>
          ...
          <div className="space-y-2 rounded-md border bg-muted/20 px-3 py-2">
            <div className="flex items-center justify-between gap-2">
              ...
              <Badge
                ...
                variant="outline"
              >
                Escalate {formatCurrency(174_000, { noDecimals: true })}
              </Badge>
            </div>
            <div className="space-y-1.5">
              <div className="flex items-center justify-between rounded-md border bg-background/70 px-2.5 py-1.5">
                ...
                <span className="text-muted-foreground text-xs tabular-nums">
                  1 deals · 14% ·{" "}
                  {formatCurrency(174_000, { noDecimals: true })}
                </span>
              </div>
              <div className="flex items-center justify-between rounded-md border bg-background/70 px-2.5 py-1.5">
                ...
                <span className="text-muted-foreground text-xs tabular-nums">
                  4 deals · 57% ·{" "}
                  {formatCurrency(478_000, { noDecimals: true })}
                </span>
              </div>
              <div className="flex items-center justify-between rounded-md border bg-background/70 px-2.5 py-1.5">
                ...
                <span className="text-muted-foreground text-xs tabular-nums">
                  2 deals · 29% ·{" "}
                  {formatCurrency(159_000, { noDecimals: true })}
                </span>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-1.5 text-xs">
              <div className="flex items-center justify-between gap-2 rounded-md border bg-background/70 px-2.5 py-1.5">
                ...
                <span className="text-muted-foreground tabular-nums">
                  4 deals · {formatCurrency(478_000, { noDecimals: true })}
                </span>
              </div>
              ...
              <div className="flex items-center justify-between gap-2 rounded-md border bg-background/70 px-2.5 py-1.5">
                ...
                <span className="text-muted-foreground tabular-nums">
                  8 deals · {formatCurrency(1_151_000, { noDecimals: true })}
                </span>
              </div>
            </div>
          </div>
