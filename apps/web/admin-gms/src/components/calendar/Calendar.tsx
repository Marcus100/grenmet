  ...
  useEffect(() => {
    ...
    setEvents([
      ...
      },
      {
        id: "2",
        title: "Meeting",
        start: new Date(Date.now() + 86_400_000).toISOString().split("T")[0],
        extendedProps: { calendar: "Success" },
      },
      {
        id: "3",
        title: "Workshop",
        start: new Date(Date.now() + 172_800_000).toISOString().split("T")[0],
        end: new Date(Date.now() + 259_200_000).toISOString().split("T")[0],
