  ...
  return (
    <ComponentCard title="Modal Based Alerts">
      <div className="flex flex-wrap items-center gap-3">
        <button
          className="rounded-lg bg-success-500 px-4 py-3 font-medium text-sm text-white shadow-gm-card hover:bg-success-600"
        ...
        <button
          className="rounded-lg bg-blue-light-500 px-4 py-3 font-medium text-sm text-white shadow-gm-card hover:bg-blue-light-600"
        ...
        <button
          className="rounded-lg bg-warning-500 px-4 py-3 font-medium text-sm text-white shadow-gm-card hover:bg-warning-600"
        ...
        <button
          className="rounded-lg bg-error-500 px-4 py-3 font-medium text-sm text-white shadow-gm-card hover:bg-error-600"
      ...
      <Dialog
        onOpenChange={(open) => {
          if (!open) successModal.closeModal();
        }}
        ...
        <DialogContent className="max-w-[600px] p-5 lg:p-10">
          <div className="text-center">
            ...
            <div className="mt-7 flex w-full items-center justify-center gap-3">
              <button
                className="flex w-full justify-center rounded-lg bg-success-500 px-4 py-3 font-medium text-sm text-white shadow-gm-card hover:bg-success-600 sm:w-auto"
                type="button"
              >
                Okay, Got It
              </button>
      ...
      >
        <DialogContent className="max-w-[600px] p-5 lg:p-10">
          <div className="text-center">
            ...
            <div className="mt-7 flex w-full items-center justify-center gap-3">
              <button
                className="flex w-full justify-center rounded-lg bg-blue-light-500 px-4 py-3 font-medium text-sm text-white shadow-gm-card hover:bg-blue-light-600 sm:w-auto"
                type="button"
              >
                Okay, Got It
              </button>
      ...
      <Dialog
        onOpenChange={(open) => {
          if (!open) warningModal.closeModal();
        }}
      ...
      >
        <DialogContent className="max-w-[600px] p-5 lg:p-10">
          <div className="text-center">
            ...
            <div className="mt-7 flex w-full items-center justify-center gap-3">
              <button
                className="flex w-full justify-center rounded-lg bg-warning-500 px-4 py-3 font-medium text-sm text-white shadow-gm-card hover:bg-warning-600 sm:w-auto"
                type="button"
              >
                Okay, Got It
              </button>
      ...
      >
        <DialogContent className="max-w-[600px] p-5 lg:p-10">
          <div className="text-center">
            ...
            <div className="mt-7 flex w-full items-center justify-center gap-3">
              <button
                className="flex w-full justify-center rounded-lg bg-error-500 px-4 py-3 font-medium text-sm text-white shadow-gm-card hover:bg-error-600 sm:w-auto"
                type="button"
              >
                Okay, Got It
              </button>
