...
import { InventoryProductCard } from "@/components/salesbus/inventory";
import { Button, SearchBar } from "@/components/salesbus/ui";
import { categories, getProductsByCategory } from "@/lib/salesbus/mock-data";
    ...
    <div className="mx-auto flex max-w-5xl flex-col gap-4 p-4 sm:gap-5 sm:p-5">
      ...
      <div className="flex gap-3">
        <SearchBar
          ...
          value={searchQuery}
        />
        <Button className="flex items-center gap-2 whitespace-nowrap bg-gm-blue-ink hover:bg-gm-navy">
