...
import { eveningForecastSchema } from "@/db/wxproducts/schema/evening.schema";
import type { MarineForecast } from "@/db/wxproducts/schema/marine.schema";
import { marineForecastSchema } from "@/db/wxproducts/schema/marine.schema";
import type { MiddayForecast } from "@/db/wxproducts/schema/midday.schema";
import { middayForecastSchema } from "@/db/wxproducts/schema/midday.schema";
import type { MorningForecast } from "@/db/wxproducts/schema/morning.schema";
import { morningForecastSchema } from "@/db/wxproducts/schema/morning.schema";
import type { TropicalOutlookForecast } from "@/db/wxproducts/schema/outlook.schema";
import { tropicalOutlookForecastSchema } from "@/db/wxproducts/schema/outlook.schema";
import type { ProductType } from "@/db/wxproducts/schema/primitives";
import { productTypeSchema } from "@/db/wxproducts/schema/primitives.schema";
