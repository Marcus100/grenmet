...
import type { CustomerBalance } from "@/lib/salesbus/types";
...
export function CustomerCard({
  ...
  return (
    <Link
      className="flex min-h-16 touch-manipulation items-center justify-between rounded-xl bg-card p-4 transition-all hover:shadow-card active:bg-muted sm:p-5"
