 ...
 * Import from @/data/wxproducts/gms-suite.example.
 */

import { gmsEveningForecastExample } from "@/data/wxproducts/gms-evening-forecast.example";
import { gmsMarineBulletinExample } from "@/data/wxproducts/gms-marine-bulletin.example";
import { gmsMiddayWeatherReportExample } from "@/data/wxproducts/gms-midday-weather-report.example";
import { gmsMorningForecastExample } from "@/data/wxproducts/gms-morning-forecast.example";
import { gmsTropicalOutlookExample } from "@/data/wxproducts/gms-tropical-outlook.example";
