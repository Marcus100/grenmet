...
import { eveningForecastSchema } from "@/db/schema/evening.schema";
import type { MarineForecast } from "@/db/schema/marine.schema";
import { marineForecastSchema } from "@/db/schema/marine.schema";
import type { MiddayForecast } from "@/db/schema/midday.schema";
import { middayForecastSchema } from "@/db/schema/midday.schema";
import type { MorningForecast } from "@/db/schema/morning.schema";
import { morningForecastSchema } from "@/db/schema/morning.schema";
