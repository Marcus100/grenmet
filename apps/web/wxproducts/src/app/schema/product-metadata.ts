...
import type { ISODateTimeString, ProductType } from "@/app/schema/primitives";
...
export interface Product<TPayload = unknown> {
  links: ProductLinks;
  payload: TPayload;
...
export function productSchema<T extends z.ZodType>(payloadSchema: T) {
  return z.object({
