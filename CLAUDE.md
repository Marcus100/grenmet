...
- The official brand is the Mini Brand Presentation 2026 kit: navy `#0b132b`, blue `#2878f5`, sky `#37a3ef`, lime `#ccf5ab`. The kit hues fail AA as small text, so use `--gm-*-ink` for text under 24px regular / 18.66px bold, for icons under ~24px, and for any fill sitting behind small white text.
